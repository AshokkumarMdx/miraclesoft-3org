...
createCertificatesForOrg3() {
  ...
  echo "## Generate the org admin msp"
  echo
  fabric-ca-client enroll -u https://org1admin:org3adminpw@localhost:10054 --caname ca.org3.example.com -M ${PWD}/../crypto-config/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
